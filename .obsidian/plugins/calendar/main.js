...
function instance$6($$self, $$props, $$invalidate) {
    ...
    $$self.$$set = ($$props) => {
        ...
        if ("isFilled" in $$props)
            $$invalidate(1, (isFilled = $$props.isFilled));
...
function instance$5($$self, $$props, $$invalidate) {
    ...
    $$self.$$set = ($$props) => {
        if ("metadata" in $$props)
            $$invalidate(0, (metadata = $$props.metadata));
            ...
            if (!mounted) {
                dispose = [
                    listen(div1, "click", function () {
                        if (
                            is_function(
                                /*onClick*/ ctx[2] && /*click_handler*/ ctx[8],
                            )
                        )
                            /*onClick*/ (
                                ctx[2] && /*click_handler*/ ctx[8]
                    ...
                    listen(div1, "pointerover", function () {
                        if (
                            is_function(
                                /*onHover*/ ctx[1] &&
                                    /*pointerover_handler*/ ctx[10],
                            )
                        )
                            /*onHover*/ (
                                ctx[1] && /*pointerover_handler*/ ctx[10]
                            ).apply(this, arguments);
                    }),
                ];
...
function instance$4($$self, $$props, $$invalidate) {
    ...
    const pointerover_handler = (e) =>
        onHover(date, e.target, isMetaPressed(e));

    $$self.$$set = ($$props) => {
        if ("date" in $$props) $$invalidate(0, (date = $$props.date));
        if ("metadata" in $$props)
            $$invalidate(7, (metadata = $$props.metadata));
    ...
    return {
                ...
                dispose = [
                    listen(h3, "click", function () {
                        if (is_function(/*resetDisplayedMonth*/ ctx[1]))
                            /*resetDisplayedMonth*/ ctx[1].apply(
                                this,
                                arguments,
                            );
                    }),
        ...
        p(new_ctx, [dirty]) {
            ...
            if (
                ...
                t0_value !==
                    (t0_value = /*displayedMonth*/ ctx[0].format("MMM") + "")
            )
                set_data(t0, t0_value);
            if (
                (!current || dirty & /*displayedMonth*/ 1) &&
                t2_value !==
                    (t2_value = /*displayedMonth*/ ctx[0].format("YYYY") + "")
            )
...
function instance$2($$self, $$props, $$invalidate) {
    ...
    $$self.$$set = ($$props) => {
        ...
        if ("resetDisplayedMonth" in $$props)
            $$invalidate(
                1,
                (resetDisplayedMonth = $$props.resetDisplayedMonth),
            );
    ...
    return {
        c() {
            ...
            toggle_class(
                ...
                "active",
                /*selectedId*/ ctx[5] ===
                    getDateUID_1(/*days*/ ctx[1][0], "week"),
            );
        },
        m(target, anchor) {
            insert(target, div1, anchor);
            ...
            if (!mounted) {
                dispose = [
                    listen(div1, "click", function () {
                        if (
                            is_function(
                                /*onClick*/ ctx[3] && /*click_handler*/ ctx[8],
                            )
                        )
                            /*onClick*/ (
                                ctx[3] && /*click_handler*/ ctx[8]
                            ).apply(this, arguments);
                    }),
                    listen(div1, "contextmenu", function () {
                        if (
                    ...
                    listen(div1, "pointerover", function () {
                        if (
                            ...
                            /*onHover*/ (
                                ctx[2] && /*pointerover_handler*/ ctx[10]
                            ).apply(this, arguments);
                    }),
                ];
        ...
        p(new_ctx, dirty) {
            ctx = new_ctx;
            if (!current || dirty & /*weekNum*/ 1)
                set_data(t0, /*weekNum*/ ctx[0]);
...
function instance$1($$self, $$props, $$invalidate) {
    ...
    $$self.$$set = ($$props) => {
        ...
        if ("metadata" in $$props)
            $$invalidate(6, (metadata = $$props.metadata));
            ...
            const weeknum_changes =
                ...
                /*month, getWeeklyMetadata, sources, today, onClickWeek, onContextMenuWeek, onHoverWeek, selectedId*/ 18344
                    ? get_spread_update(weeknum_spread_levels, [
                          dirty & /*month*/ 16384 &&
                              get_spread_object(/*week*/ ctx[18]),
                          dirty &
                              /*getWeeklyMetadata, sources, month, today*/ 17664 && {
                              metadata: getWeeklyMetadata(
                                  /*sources*/ ctx[8],
                                  /*week*/ ctx[18].days[0],
                                  /*today*/ ctx[10],
    ...
    return {
        ...
        p(new_ctx, dirty) {
            ...
            if (dirty & /*onHoverDay*/ 4)
                day_changes.onHover = /*onHoverDay*/ ctx[2];
...
function create_fragment(ctx) {
    ...
    return {
        ...
        p(ctx, [dirty]) {
            ...
            if (dirty & /*today*/ 512)
                calendarbase_changes.today = /*today*/ ctx[9];
            if (dirty & /*onHoverDay*/ 4)
            ...
            if (dirty & /*onContextMenuDay*/ 64)
                calendarbase_changes.onContextMenuDay =
                    /*onContextMenuDay*/ ctx[6];
            if (dirty & /*onContextMenuWeek*/ 128)
                calendarbase_changes.onContextMenuWeek =
            ...
            if (dirty & /*$settings*/ 256)
                calendarbase_changes.showWeekNums =
                    /*$settings*/ ctx[8].showWeeklyNote;
...
function getNoteTags(note) {
    ...
    if (frontmatter) {
        const frontmatterTags =
            obsidian.parseFrontMatterTags(frontmatter) || [];
...
class CalendarView extends obsidian.ItemView {
    ...
    async openOrCreateWeeklyNote(date, inNewSplit) {
        ...
        const existingFile = getWeeklyNote_1(
            date,
