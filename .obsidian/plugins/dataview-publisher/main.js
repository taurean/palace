        ...
        function explainFromTokens(locale, input, format) {
            ...
            if (disqualifyingUnit) {
                ...
                const [regexString, handlers] = buildRegex(units),
                    ...
                    [result2, zone, specificOffset] = matches
        ...
        (function (Values2) {
            function toString(
                ...
                switch (wrapped.type) {
                    ...
                    case "array":
                        let result2 = "";
                        if (recursive) result2 += "[";
                        result2 += wrapped.value
            ...
            function mapLeaves(val, func) {
                if (isObject(val)) {
                    ...
                    let result2 = [];
                    for (let value of val) result2.push(mapLeaves(value, func));
                    return result2;
                } else {
                    return func(val);
                }
        ...
        (function (Groupings2) {
            ...
            function isGrouping(entry) {
                for (let element of entry)
                    if (!isElementGroup(element)) return false;
                return true;
            }
            ...
            return parsimmon_umd_min.exports.custom((success, failure) => {
                return (input, i) => {
                    ...
                    return Object.assign({}, result2, {
                        value: [
                            result2.value,
                            input.substring(i, result2.index),
                        ],
                    });
                };
            });
...
async function executeBlock(block, dv, tfile) {
    if (
        ["dataviewjs", "javascript", "js"].some((x) =>
            block.language.startsWith(x),
        )
    ) {
        const file = tfile;
...
async function executeQueryMarkdown(query, dv2, originFile) {
    const result2 = await dv2.tryQueryMarkdown(
        query,
        originFile == null ? void 0 : originFile.path,
    );
...
function extractMarkdownCodeBlock(text) {
    ...
    const language =
        (_c =
            (_b = (_a = match.groups) == null ? void 0 : _a.language) == null
                ? void 0
                : _b.trim()) != null
            ? _c
            : "";
    const query =
        (_f =
            (_e = (_d = match.groups) == null ? void 0 : _d.query) == null
                ? void 0
                : _e.trim()) != null
            ? _f
            : "";
...
var Operator = class {
    ...
    async updateActiveFile(editor) {
        ...
        const replacer = await createReplacerFromContent(
            content,
            this.dv,
            tfile2,
        );
    ...
    updateContent(content, replacer) {
        return replacer.reduce((c, { searchValue, replaceValue }) => {
