...
function getWeeklyNoteSettings() {
    try {
        ...
        if (shouldUsePeriodicNotesSettings("weekly")) {
            return {
                format:
                    periodicNotesSettings.format || DEFAULT_WEEKLY_NOTE_FORMAT,
    ...
    try {
        const settings =
            (shouldUsePeriodicNotesSettings("quarterly") &&
                pluginManager.getPlugin("periodic-notes")?.settings
                    ?.quarterly) ||
            {};
        return {
...
pattern.matchAnyPattern =
    ...
    pattern.repeatedTimeunitPattern =
        void 0;
    ...
    _proto.diff = function diff(input, units, _float) {
        ...
        result =
            ...
            (_C$Y$C$M$C$Q$C$W$C$D$[W] =
                (diff - zoneDelta) / MILLISECONDS_A_WEEK),
            (_C$Y$C$M$C$Q$C$W$C$D$[D] =
                (diff - zoneDelta) / MILLISECONDS_A_DAY),
...
dayjs.implySimilarTime =
    dayjs.assignSimilarTime =
    dayjs.assignSimilarDate =
...
results.ParsingResult =
    results.ParsingComponents =
    results.ReferenceWithTimezone =
        void 0;
        ...
        if (input instanceof Date) {
            ...
            this.instant =
                (_a = input.instant) !== null && _a !== void 0
                    ? _a
                    : new Date();
            this.timezoneOffset = (0, timezone_1.toTimezoneOffset)(
                input.timezone,
            );
        }
    }
...
class ParsingComponents {
    ...
    date() {
        ...
        return new Date(
            date.getTime() +
                this.getSystemTimezoneAdjustmentMinute(date) * 60000,
        );
    }
        ...
        const targetTimezoneOffset =
            (_b =
                (_a = this.get("timezoneOffset")) !== null && _a !== void 0
                    ? _a
                    : this.reference.timezoneOffset) !== null && _b !== void 0
                ? _b
...
Object.defineProperty(AbstractParserWithWordBoundary, "__esModule", {
    value: true,
});
...
AbstractParserWithWordBoundary.AbstractParserWithWordBoundaryChecking =
    AbstractParserWithWordBoundaryChecking;

Object.defineProperty(ENTimeUnitWithinFormatParser$1, "__esModule", {
    value: true,
});
...
class ENTimeUnitWithinFormatParser extends AbstractParserWithWordBoundary_1$R.AbstractParserWithWordBoundaryChecking {
    ...
    innerExtract(context, match) {
        ...
        return results_1$e.ParsingComponents.createRelativeFromReference(
            context.reference,
            timeUnits,
        );
    }
...
Object.defineProperty(ENMonthNameLittleEndianParser$1, "__esModule", {
    value: true,
});
...
class ENMonthNameLittleEndianParser extends AbstractParserWithWordBoundary_1$Q.AbstractParserWithWordBoundaryChecking {
    ...
    innerExtract(context, match) {
        ...
        const month =
            constants_1$B.MONTH_DICTIONARY[
                match[MONTH_NAME_GROUP$9].toLowerCase()
            ];
        const day = (0, constants_3$3.parseOrdinalNumberPattern)(
            match[DATE_GROUP$7],
        );
        if (day > 31) {
        ...
        if (match[YEAR_GROUP$c]) {
            const yearNumber = (0, constants_2$7.parseYear)(
                match[YEAR_GROUP$c],
            );
            result.start.assign("year", yearNumber);
        } else {
            const year = (0, years_1$9.findYearClosestToRef)(
                context.refDate,
                day,
                month,
            );
        ...
        if (match[DATE_TO_GROUP$5]) {
            const endDate = (0, constants_3$3.parseOrdinalNumberPattern)(
                match[DATE_TO_GROUP$5],
            );
...
Object.defineProperty(ENMonthNameMiddleEndianParser$1, "__esModule", {
    value: true,
});
...
class ENMonthNameMiddleEndianParser extends AbstractParserWithWordBoundary_1$P.AbstractParserWithWordBoundaryChecking {
    ...
    innerExtract(context, match) {
        const month =
            constants_1$A.MONTH_DICTIONARY[
                match[MONTH_NAME_GROUP$8].toLowerCase()
            ];
        const day = (0, constants_2$6.parseOrdinalNumberPattern)(
            match[DATE_GROUP$6],
        );
        if (day > 31) {
            return null;
        ...
        if (match[YEAR_GROUP$b]) {
            ...
            const year = (0, years_1$8.findYearClosestToRef)(
                context.refDate,
                day,
                month,
            );
        ...
        const endDate = (0, constants_2$6.parseOrdinalNumberPattern)(
            match[DATE_TO_GROUP$4],
        );
        const result = context.createParsingResult(match.index, match[0]);
...
class ENMonthNameParser extends AbstractParserWithWordBoundary_1$O.AbstractParserWithWordBoundaryChecking {
    ...
    innerExtract(context, match) {
        ...
        if (
            match[0].length <= 3 &&
            !constants_1$z.FULL_MONTH_NAME_DICTIONARY[monthName]
        ) {
            return null;
        }
        ...
        if (match[YEAR_GROUP$a]) {
            ...
            const year = (0, years_1$7.findYearClosestToRef)(
                context.refDate,
                1,
                month,
            );
...
Object.defineProperty(ENCasualYearMonthDayParser$1, "__esModule", {
    value: true,
});
...
class ENCasualYearMonthDayParser extends AbstractParserWithWordBoundary_1$N.AbstractParserWithWordBoundaryChecking {
    ...
    innerExtract(context, match) {
        const month = match[MONTH_NUMBER_GROUP$2]
            ...
            : constants_1$y.MONTH_DICTIONARY[
                  match[MONTH_NAME_GROUP$6].toLowerCase()
              ];
        if (month < 1 || month > 12) {
            return null;
        }
...
Object.defineProperty(ENSlashMonthFormatParser$1, "__esModule", {
    value: true,
});
...
Object.defineProperty(AbstractTimeExpressionParser$1, "__esModule", {
    value: true,
});
...
class AbstractTimeExpressionParser {
    ...
    extractPrimaryTimeComponents(context, match, strict = false) {
        ...
        if (match[MINUTE_GROUP$3] != null) {
            if (
                match[MINUTE_GROUP$3].length == 1 &&
                !match[AM_PM_HOUR_GROUP$3]
            ) {
                return null;
            }
...
AbstractTimeExpressionParser$1.AbstractTimeExpressionParser =
...
Object.defineProperty(ENTimeUnitAgoFormatParser$1, "__esModule", {
    value: true,
});
...
const PATTERN$w = new RegExp(
    `(${constants_1$x.TIME_UNITS_PATTERN})\\s{0,5}(?:ago|before|earlier)(?=(?:\\W|$))`,
    "i",
);
const STRICT_PATTERN$3 = new RegExp(
    `(${constants_1$x.TIME_UNITS_PATTERN})\\s{0,5}ago(?=(?:\\W|$))`,
    "i",
);
class ENTimeUnitAgoFormatParser extends AbstractParserWithWordBoundary_1$L.AbstractParserWithWordBoundaryChecking {
    ...
    innerExtract(context, match) {
        ...
        return results_1$d.ParsingComponents.createRelativeFromReference(
            context.reference,
            outputTimeUnits,
        );
    }
...
Object.defineProperty(ENTimeUnitLaterFormatParser$1, "__esModule", {
    value: true,
});
...
const PATTERN$v = new RegExp(
    `(${constants_1$w.TIME_UNITS_PATTERN})\\s{0,5}(?:later|after|from now|henceforth|forward|out)` +
        "(?=(?:\\W|$))",
    "i",
);
const STRICT_PATTERN$2 = new RegExp(
    "" +
        "(" +
        constants_1$w.TIME_UNITS_PATTERN +
        ")" +
        "(later|from now)" +
        "(?=(?:\\W|$))",
    "i",
...
class ENTimeUnitLaterFormatParser extends AbstractParserWithWordBoundary_1$K.AbstractParserWithWordBoundaryChecking {
    ...
    innerExtract(context, match) {
        const fragments = (0, constants_1$w.parseTimeUnits)(
            match[GROUP_NUM_TIMEUNITS$1],
        );
        return results_1$c.ParsingComponents.createRelativeFromReference(
            context.reference,
            fragments,
        );
    }
...
Object.defineProperty(AbstractMergeDateRangeRefiner$1, "__esModule", {
    value: true,
});
...
const AbstractMergeDateRangeRefiner_1$7 = __importDefault$G(
    AbstractMergeDateRangeRefiner$1,
);
...
mergingCalculation.mergeDateTimeComponent =
    mergingCalculation.mergeDateTimeResult = void 0;
...
function mergeDateTimeComponent(dateComponent, timeComponent) {
    ...
    if (
        dateTimeComponent.get("meridiem") == index_1$b.Meridiem.PM &&
...
Object.defineProperty(AbstractMergeDateTimeRefiner, "__esModule", {
    value: true,
});
...
class ENMergeDateTimeRefiner$1 extends abstractRefiners_1$2.MergingRefiner {
    ...
    mergeResults(textBetween, currentResult, nextResult) {
        const result = currentResult.start.isOnlyDate()
            ? (0, mergingCalculation_1.mergeDateTimeResult)(
                  currentResult,
                  nextResult,
              )
            : (0, mergingCalculation_1.mergeDateTimeResult)(
...
const AbstractMergeDateTimeRefiner_1$6 = __importDefault$F(
...
Object.defineProperty(ExtractTimezoneAbbrRefiner$1, "__esModule", {
    value: true,
});
...
Object.defineProperty(ExtractTimezoneOffsetRefiner$1, "__esModule", {
    value: true,
});
...
Object.defineProperty(MergeWeekdayComponentRefiner$1, "__esModule", {
    value: true,
});
...
const ExtractTimezoneAbbrRefiner_1 = __importDefault$D(
    ExtractTimezoneAbbrRefiner$1,
);
const ExtractTimezoneOffsetRefiner_1 = __importDefault$D(
...
const MergeWeekdayComponentRefiner_1 = __importDefault$D(
    MergeWeekdayComponentRefiner$1,
);
    ...
    const weekStart =
        (_a =
            locale === null || locale === void 0
                ? void 0
                : locale.weekStart) !== null && _a !== void 0
            ? _a
            : 0;
...
function toDayJSClosestWeekday(refDate, offset, locale) {
    ...
    const weekdayOffset = (7 + offset - weekStart) % 7;
    if (
        Math.abs(weekdayOffset - 7 - refOffset) <
        Math.abs(weekdayOffset - refOffset)
    ) {
        date = date.weekday(weekdayOffset - 7);
    } else if (
        Math.abs(weekdayOffset + 7 - refOffset) <
...
class ENWeekdayParser extends AbstractParserWithWordBoundary_1$G.AbstractParserWithWordBoundaryChecking {
    ...
    innerExtract(context, match) {
        ...
        const date = (0, weeks_1$4.toDayJSWeekday)(
            context.refDate,
            offset,
            modifier,
...
Object.defineProperty(ENRelativeDateFormatParser$1, "__esModule", {
    value: true,
});
...
class ENRelativeDateFormatParser extends AbstractParserWithWordBoundary_1$F.AbstractParserWithWordBoundaryChecking {
    ...
    innerExtract(context, match) {
        ...
        if (modifier == "next") {
            ...
            return results_1$a.ParsingComponents.createRelativeFromReference(
                context.reference,
                timeUnits,
            );
        }
...
class ParsingContext {
    ...
    createParsingResult(index, textOrEndIndex, startComponents, endComponents) {
        ...
        const end = endComponents
            ...
            : null;
        return new results_1$9.ParsingResult(
            this.reference,
            index,
            text,
            start,
...
class SlashDateFormatParser {
    ...
    extract(context, match) {
        ...
        if (match[YEAR_GROUP$8]) {
            ...
            const year = (0, years_1$6.findYearClosestToRef)(
                context.refDate,
                day,
                month,
            );
...
Object.defineProperty(ENTimeUnitCasualRelativeFormatParser$1, "__esModule", {
    value: true,
});
...
const PATTERN$o = new RegExp(
    `(this|last|past|next|\\+|-)\\s*(${constants_1$t.TIME_UNITS_PATTERN})(?=\\W|$)`,
    "i",
);
class ENTimeUnitCasualRelativeFormatParser extends AbstractParserWithWordBoundary_1$E.AbstractParserWithWordBoundaryChecking {
    ...
    innerExtract(context, match) {
        ...
        return results_1$8.ParsingComponents.createRelativeFromReference(
            context.reference,
            timeUnits,
        );
    }
}
ENTimeUnitCasualRelativeFormatParser$1.default =
...
(function (exports) {
    ...
    const ENTimeUnitCasualRelativeFormatParser_1 = __importDefault(
        ENTimeUnitCasualRelativeFormatParser$1,
    );
...
class DEWeekdayParser extends AbstractParserWithWordBoundary_1$D.AbstractParserWithWordBoundaryChecking {
    ...
    innerExtract(context, match) {
        ...
        const date = (0, weeks_1$3.toDayJSWeekday)(
            context.refDate,
            offset,
            modifier,
        );
...
const AbstractMergeDateRangeRefiner_1$6 = __importDefault$x(
    AbstractMergeDateRangeRefiner$1,
);
...
const AbstractMergeDateTimeRefiner_1$5 = __importDefault$w(
    AbstractMergeDateTimeRefiner,
);
        ...
        switch (timeKeywordPattern) {
            ...
            case "mitternacht":
                if (component.get("hour") > 1) {
                    component = (0, timeunits_1$4.addImpliedTimeUnits)(
                        component,
                        { day: 1 },
                    );
                }
...
Object.defineProperty(DEMonthNameLittleEndianParser$1, "__esModule", {
    value: true,
});
...
class DEMonthNameLittleEndianParser extends AbstractParserWithWordBoundary_1$A.AbstractParserWithWordBoundaryChecking {
    ...
    innerExtract(context, match) {
        const result = context.createParsingResult(match.index, match[0]);
        const month =
            constants_1$r.MONTH_DICTIONARY[
                match[MONTH_NAME_GROUP$5].toLowerCase()
            ];
        ...
        if (match[YEAR_GROUP$7]) {
            const yearNumber = (0, constants_2$4.parseYear)(
                match[YEAR_GROUP$7],
            );
            result.start.assign("year", yearNumber);
        } else {
            const year = (0, years_1$5.findYearClosestToRef)(
                context.refDate,
                day,
                month,
            );
...
(function (exports) {
    ...
    const DEMonthNameLittleEndianParser_1 = __importDefault(
        DEMonthNameLittleEndianParser$1,
    );
...
const AbstractMergeDateTimeRefiner_1$4 = __importDefault$s(
    AbstractMergeDateTimeRefiner,
);
...
const AbstractMergeDateRangeRefiner_1$5 = __importDefault$r(
    AbstractMergeDateRangeRefiner$1,
);
...
class FRWeekdayParser extends AbstractParserWithWordBoundary_1$x.AbstractParserWithWordBoundaryChecking {
    ...
    innerExtract(context, match) {
        ...
        const date = (0, weeks_1$2.toDayJSWeekday)(
            context.refDate,
            offset,
            modifier,
        );
...
Object.defineProperty(FRSpecificTimeExpressionParser$1, "__esModule", {
    value: true,
});
...
Object.defineProperty(FRMonthNameLittleEndianParser$1, "__esModule", {
    value: true,
});
...
class FRMonthNameLittleEndianParser extends AbstractParserWithWordBoundary_1$w.AbstractParserWithWordBoundaryChecking {
    ...
    innerExtract(context, match) {
        const result = context.createParsingResult(match.index, match[0]);
        const month =
            constants_1$p.MONTH_DICTIONARY[
                match[MONTH_NAME_GROUP$4].toLowerCase()
            ];
        const day = (0, constants_3$1.parseOrdinalNumberPattern)(
            match[DATE_GROUP$3],
        );
        if (day > 31) {
        ...
        if (match[YEAR_GROUP$6]) {
            const yearNumber = (0, constants_2$3.parseYear)(
                match[YEAR_GROUP$6],
            );
            result.start.assign("year", yearNumber);
        } else {
            const year = (0, years_1$4.findYearClosestToRef)(
                context.refDate,
                day,
                month,
            );
        ...
        if (match[DATE_TO_GROUP$2]) {
            const endDate = (0, constants_3$1.parseOrdinalNumberPattern)(
                match[DATE_TO_GROUP$2],
            );
            result.end = result.start.clone();
            result.end.assign("day", endDate);
        }
...
Object.defineProperty(FRTimeUnitAgoFormatParser$2, "__esModule", {
    value: true,
});
...
class FRTimeUnitAgoFormatParser$1 extends AbstractParserWithWordBoundary_1$v.AbstractParserWithWordBoundaryChecking {
    ...
    innerPattern() {
        return new RegExp(
            `il y a\\s*(${constants_1$o.TIME_UNITS_PATTERN})(?=(?:\\W|$))`,
            "i",
        );
    }
    innerExtract(context, match) {
        ...
        return results_1$7.ParsingComponents.createRelativeFromReference(
            context.reference,
            outputTimeUnits,
        );
    }
...
Object.defineProperty(FRTimeUnitWithinFormatParser$1, "__esModule", {
    value: true,
});
...
class FRTimeUnitWithinFormatParser extends AbstractParserWithWordBoundary_1$u.AbstractParserWithWordBoundaryChecking {
    innerPattern() {
        return new RegExp(
            `(?:dans|en|pour|pendant)\\s*(${constants_1$n.TIME_UNITS_PATTERN})(?=\\W|$)`,
            "i",
        );
    }
    innerExtract(context, match) {
        const timeUnits = (0, constants_1$n.parseTimeUnits)(match[1]);
        return results_1$6.ParsingComponents.createRelativeFromReference(
            context.reference,
            timeUnits,
        );
    }
...
Object.defineProperty(FRTimeUnitRelativeFormatParser, "__esModule", {
    value: true,
});
...
class FRTimeUnitAgoFormatParser extends AbstractParserWithWordBoundary_1$t.AbstractParserWithWordBoundaryChecking {
    ...
    innerExtract(context, match) {
        const num = match[1]
            ? (0, constants_1$m.parseNumberPattern)(match[1])
            : 1;
        ...
        return results_1$5.ParsingComponents.createRelativeFromReference(
            context.reference,
            timeUnits,
        );
    }
...
class JPStandardParser {
    ...
    extract(context, match) {
        const month = parseInt(
            (0, constants_1$l.toHankaku)(match[MONTH_GROUP$3]),
        );
        ...
        if (match[TYPICAL_YEAR_GROUP]) {
            ...
            let year =
                yearNumText == "元"
                    ? 1
                    : parseInt((0, constants_1$l.toHankaku)(yearNumText));
            ...
            const year = (0, years_1$3.findYearClosestToRef)(
                context.refDate,
                day,
                month,
            );
...
const AbstractMergeDateRangeRefiner_1$4 = __importDefault$p(
    AbstractMergeDateRangeRefiner$1,
);
...
class PTWeekdayParser extends AbstractParserWithWordBoundary_1$s.AbstractParserWithWordBoundaryChecking {
    ...
    innerExtract(context, match) {
        ...
        const date = (0, weeks_1$1.toDayJSWeekday)(
            context.refDate,
            offset,
            modifier,
        );
...
const AbstractMergeDateTimeRefiner_1$3 = __importDefault$n(
    AbstractMergeDateTimeRefiner,
);
...
const AbstractMergeDateRangeRefiner_1$3 = __importDefault$m(
    AbstractMergeDateRangeRefiner$1,
);
...
Object.defineProperty(PTMonthNameLittleEndianParser$1, "__esModule", {
    value: true,
});
...
class PTMonthNameLittleEndianParser extends AbstractParserWithWordBoundary_1$r.AbstractParserWithWordBoundaryChecking {
    ...
    innerExtract(context, match) {
        const result = context.createParsingResult(match.index, match[0]);
        const month =
            constants_1$j.MONTH_DICTIONARY[
                match[MONTH_NAME_GROUP$3].toLowerCase()
            ];
        ...
        if (match[YEAR_GROUP$5]) {
            const yearNumber = (0, constants_2$2.parseYear)(
                match[YEAR_GROUP$5],
            );
            result.start.assign("year", yearNumber);
        } else {
            const year = (0, years_1$2.findYearClosestToRef)(
                context.refDate,
                day,
                month,
            );
...
(function (exports) {
    ...
    const PTMergeDateRangeRefiner_1 = __importDefault(
        PTMergeDateRangeRefiner$1,
    );
    const PTMonthNameLittleEndianParser_1 = __importDefault(
        PTMonthNameLittleEndianParser$1,
    );
...
const AbstractMergeDateRangeRefiner_1$2 = __importDefault$k(
    AbstractMergeDateRangeRefiner$1,
);
...
const AbstractMergeDateTimeRefiner_1$2 = __importDefault$j(
    AbstractMergeDateTimeRefiner,
);
...
Object.defineProperty(NLTimeUnitWithinFormatParser$1, "__esModule", {
    value: true,
});
...
class NLTimeUnitWithinFormatParser extends AbstractParserWithWordBoundary_1$m.AbstractParserWithWordBoundaryChecking {
    innerPattern() {
        return new RegExp(
            `(?:binnen|in|binnen de|voor)\\s*` +
                "(" +
                constants_1$i.TIME_UNITS_PATTERN +
                ")" +
                `(?=\\W|$)`,
            "i",
        );
    ...
    innerExtract(context, match) {
        ...
        return results_1$4.ParsingComponents.createRelativeFromReference(
            context.reference,
            timeUnits,
        );
    }
...
class NLWeekdayParser extends AbstractParserWithWordBoundary_1$l.AbstractParserWithWordBoundaryChecking {
    ...
    innerExtract(context, match) {
        ...
        const date = (0, weeks_1.toDayJSWeekday)(
            context.refDate,
            offset,
            modifier,
        );
...
Object.defineProperty(NLMonthNameMiddleEndianParser$1, "__esModule", {
    value: true,
});
...
class NLMonthNameMiddleEndianParser extends AbstractParserWithWordBoundary_1$k.AbstractParserWithWordBoundaryChecking {
    ...
    innerExtract(context, match) {
        const month =
            constants_1$g.MONTH_DICTIONARY[
                match[MONTH_NAME_GROUP$2].toLowerCase()
            ];
        const day = (0, constants_2$1.parseOrdinalNumberPattern)(
            match[DATE_GROUP$1],
        );
        if (day > 31) {
        ...
        if (match[YEAR_GROUP$4]) {
            ...
            const year = (0, years_1$1.findYearClosestToRef)(
                context.refDate,
                day,
                month,
            );
        ...
        const endDate = (0, constants_2$1.parseOrdinalNumberPattern)(
            match[DATE_TO_GROUP],
        );
        const result = context.createParsingResult(match.index, match[0]);
        result.start = components;
...
class NLMonthNameParser extends AbstractParserWithWordBoundary_1$j.AbstractParserWithWordBoundaryChecking {
    ...
    innerExtract(context, match) {
        ...
        if (match[YEAR_GROUP$3]) {
            ...
            const year = (0, years_1.findYearClosestToRef)(
                context.refDate,
                1,
                month,
            );
...
Object.defineProperty(NLSlashMonthFormatParser$1, "__esModule", {
    value: true,
});
const AbstractParserWithWordBoundary_1$i = AbstractParserWithWordBoundary;
...
Object.defineProperty(NLCasualYearMonthDayParser$1, "__esModule", {
    value: true,
});
...
class NLCasualYearMonthDayParser extends AbstractParserWithWordBoundary_1$h.AbstractParserWithWordBoundaryChecking {
    ...
    innerExtract(context, match) {
        const month = match[MONTH_NUMBER_GROUP]
            ...
            : constants_1$e.MONTH_DICTIONARY[
...
Object.defineProperty(NLTimeUnitCasualRelativeFormatParser$1, "__esModule", {
    value: true,
});
...
class NLTimeUnitCasualRelativeFormatParser extends AbstractParserWithWordBoundary_1$f.AbstractParserWithWordBoundaryChecking {
    ...
    innerExtract(context, match) {
        ...
        return results_1$3.ParsingComponents.createRelativeFromReference(
            context.reference,
            timeUnits,
        );
    }
}
NLTimeUnitCasualRelativeFormatParser$1.default =
...
Object.defineProperty(NLRelativeDateFormatParser$1, "__esModule", {
    value: true,
});
...
class NLRelativeDateFormatParser extends AbstractParserWithWordBoundary_1$e.AbstractParserWithWordBoundaryChecking {
    ...
    innerExtract(context, match) {
        ...
        if (
            ...
            const timeUnits = {};
            timeUnits[timeunit] = 1;
            return results_1$2.ParsingComponents.createRelativeFromReference(
                context.reference,
                timeUnits,
            );
        }
...
Object.defineProperty(NLTimeUnitAgoFormatParser$1, "__esModule", {
    value: true,
});
...
const PATTERN$7 = new RegExp(
    "" +
        "(" +
        constants_1$b.TIME_UNITS_PATTERN +
        ")" +
        "(?:geleden|voor|eerder)(?=(?:\\W|$))",
    "i",
);
const STRICT_PATTERN$1 = new RegExp(
    "" + "(" + constants_1$b.TIME_UNITS_PATTERN + ")" + "geleden(?=(?:\\W|$))",
    "i",
);
class NLTimeUnitAgoFormatParser extends AbstractParserWithWordBoundary_1$d.AbstractParserWithWordBoundaryChecking {
    ...
    innerExtract(context, match) {
        ...
        return results_1$1.ParsingComponents.createRelativeFromReference(
            context.reference,
            outputTimeUnits,
        );
    }
...
Object.defineProperty(NLTimeUnitLaterFormatParser$1, "__esModule", {
    value: true,
});
...
const PATTERN$6 = new RegExp(
    "" +
        "(" +
        constants_1$a.TIME_UNITS_PATTERN +
        ")" +
...
class NLTimeUnitLaterFormatParser extends AbstractParserWithWordBoundary_1$c.AbstractParserWithWordBoundaryChecking {
    ...
    innerExtract(context, match) {
        const fragments = (0, constants_1$a.parseTimeUnits)(
...
Object.defineProperty(ZHHantDeadlineFormatParser$1, "__esModule", {
    value: true,
});
...
Object.defineProperty(ZHHantRelationWeekdayParser$1, "__esModule", {
    value: true,
});
...
Object.defineProperty(ZHHantTimeExpressionParser$1, "__esModule", {
    value: true,
});
...
class ZHHantTimeExpressionParser extends AbstractParserWithWordBoundary_1$7.AbstractParserWithWordBoundaryChecking {
    ...
    innerExtract(context, match) {
        ...
        if (match[SECOND_GROUP$1]) {
            ...
            if (isNaN(second)) {
                second = (0, constants_1$6.zhStringToNumber)(
                    match[SECOND_GROUP$1],
                );
            }
            if (second >= 60) return null;
        ...
        if (match[MINUTE_GROUP$1]) {
            if (match[MINUTE_GROUP$1] == "半") {
                ...
                match[MINUTE_GROUP$1] == "正" ||
                match[MINUTE_GROUP$1] == "整"
            ) {
                minute = 0;
            } else {
                minute = parseInt(match[MINUTE_GROUP$1]);
                if (isNaN(minute)) {
                    minute = (0, constants_1$6.zhStringToNumber)(
                        match[MINUTE_GROUP$1],
                    );
                }
            }
        } else if (hour > 100) {
        ...
        match = SECOND_REG_PATTERN$1.exec(
...
const PATTERN$3 = new RegExp(
    "(?:星期|禮拜|週)(?<weekday>" +
        Object.keys(constants_1$5.WEEKDAY_OFFSET).join("|") +
        ")",
);
...
Object.defineProperty(ZHHantMergeDateRangeRefiner$1, "__esModule", {
    value: true,
});
const AbstractMergeDateRangeRefiner_1$1 = __importDefault$9(
    AbstractMergeDateRangeRefiner$1,
);
...
Object.defineProperty(ZHHantMergeDateTimeRefiner$1, "__esModule", {
    value: true,
});
const AbstractMergeDateTimeRefiner_1$1 = __importDefault$8(
    AbstractMergeDateTimeRefiner,
);
...
Object.defineProperty(ZHHansDeadlineFormatParser$1, "__esModule", {
    value: true,
});
...
Object.defineProperty(ZHHansRelationWeekdayParser$1, "__esModule", {
    value: true,
});
...
const PATTERN$1 = new RegExp(
    "(?<prefix>上|下|这)(?:个)?(?:星期|礼拜|周)(?<weekday>" +
        Object.keys(constants_1$2.WEEKDAY_OFFSET).join("|") +
        ")",
);
...
Object.defineProperty(ZHHansTimeExpressionParser$1, "__esModule", {
    value: true,
});
...
class ZHHansTimeExpressionParser extends AbstractParserWithWordBoundary_1$1.AbstractParserWithWordBoundaryChecking {
    ...
    innerExtract(context, match) {
        ...
        if (match[SECOND_GROUP]) {
            ...
            if (isNaN(second)) {
                second = (0, constants_1$1.zhStringToNumber)(
                    match[SECOND_GROUP],
                );
            }
            if (second >= 60) return null;
        ...
        if (match[MINUTE_GROUP]) {
            if (match[MINUTE_GROUP] == "半") {
                ...
                if (isNaN(minute)) {
                    minute = (0, constants_1$1.zhStringToNumber)(
                        match[MINUTE_GROUP],
                    );
                }
            }
...
Object.defineProperty(ZHHansMergeDateRangeRefiner$1, "__esModule", {
    value: true,
});
const AbstractMergeDateRangeRefiner_1 = __importDefault$1(
    AbstractMergeDateRangeRefiner$1,
);
...
Object.defineProperty(ZHHansMergeDateTimeRefiner$1, "__esModule", {
    value: true,
});
...
class NLDParser {
    ...
    getParsedDate(selectedText, weekStartPreference) {
        ...
        const weekdayIsCertain =
            (_a = initialParse[0]) === null || _a === void 0
                ? void 0
                : _a.start.isCertain("weekday");
        const weekStart =
...
class NLDSettingsTab extends require$$0$1.PluginSettingTab {
    ...
    display() {
        ...
        new require$$0$1.Setting(containerEl)
            .setName("Separator")
            .setDesc(
                "Separator between date and time for entries that have both",
            )
            .addText((text) =>
                text
        ...
        new require$$0$1.Setting(containerEl)
            ...
            .setDesc(
                "Character(s) that will cause the date autosuggest to open",
            )
            .addMomentFormat((text) =>
                text
...
class DateSuggest extends require$$0$1.EditorSuggest {
    ...
    onTrigger(cursor, editor, file) {
        ...
        const startPos = ((_a = this.context) === null || _a === void 0
            ? void 0
            : _a.start) || {
            line: cursor.line,
    ...
    */
    parse(dateString, format) {
        ...
        if (formattedString === "Invalid date") {
            console.debug(
                "Input date " + dateString + " can't be parsed by nldates",
            );
        }
        return {
            formattedString,
