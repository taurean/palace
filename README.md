...
5. Go to the Interpreter settings page and add your preferred AI Provider and AI model.
    - You will need your own API key](<# Palace Obsidian Vault Template [![GitHub Release](https://img.shields.io/github/v/release/taurean/palace?include_prereleases&style=flat-square)](https://github.com/taurean/palace/tags)

**Palace** is an opinionated starter system for building an [Obsidian](https://obsidian.md) vault with staying power. It's thorough and may have a slight learning curve, but it's designed as a foundation for you to modify however you need Obsidian to work.

This README is here to give the [GitHub Repo](https://github.com/taurean/palace) context and can be deleted once you're set up. If you want to read more about the folder structure, bases, templates, hotkeys, plugins, and more, check out the [Palace docs](/system/getting-started.md). 

**To download the latest version of Palace, visit the [Releases page for the repo](https://github.com/taurean/palace/releases)**.
...
### Web clipper
1. Download your browser's extension
    - [Chrome](https://chromewebstore.google.com/detail/obsidian-web-clipper/cnjifjpddelmedmihgijeibhnjfabmlf)
    - [Firefox](https://addons.mozilla.org/en-US/firefox/addon/web-clipper-obsidian/)
    - [Safari](https://apps.apple.com/us/app/obsidian-web-clipper/id6720708363)
    - [Edge](https://microsoftedge.microsoft.com/addons/detail/obsidian-web-clipper/eigdjhmgnaaeaonimdklocfekkaanfme)
2. Open the extension dropdown in your browser, then select the settings gear icon in the top right
3. For each template that you will use, create a new template and import the matching `.json` file in _`/curtain/clipper-templates/`_
4. In **General**, find the section titled **Vaults**, type in the exact name of your vault and _press enter_.
5. Go to the Interpreter settings page and add your preferred AI Provider and AI model.
